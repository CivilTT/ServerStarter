    ...
    <q-card-section>
      ...
      <q-stepper v-model="step_intro" flat vertical animated>
            ...
            <q-expansion-item label="ダウンロード時に警告が出た場合" header-class="bg-orange-4">
              <q-card flat class="bg-orange-2">
                <q-card-section>
                  ...
                  <q-img src="src/assets/Introduction/Edge_Save1.png" width="min(400px,100%)" />
                  <q-img src="src/assets/Introduction/Edge_Save2.png" width="min(400px,100%)" />
                </q-card-section>
              </q-card>
            </q-expansion-item>
          </div>
        ...
        <q-step :name="2" title="2. 起動" :done="step_intro > 2">
          ...
          <q-img src="src/assets/Introduction/Icon.png" width="min(200px,100%)" />
          <q-stepper-navigation>
        ...
        <q-step :name="3" title="3-1. 初期設定（利用規約）" :done="step_intro > 3">
          ...
          <q-img src="src/assets/Introduction/WelcomeWindow.png" width="min(500px,100%)" />
          <q-stepper-navigation>
        ...
        <q-step :name="4" title="3-2. 初期設定（プレイヤー登録）" :done="step_intro > 3">
          ...
          <q-img src="src/assets/Introduction/OwnerPlayerSetting1.png" width="min(500px,100%)" />
          <p>
            自身のプレイヤー名を入力すると、以下の画像のように候補が表示されます<br>
            「このプレイヤーを登録」ボタンを押し、「オーナーを登録」できるようになります</p>
          <q-img src="src/assets/Introduction/OwnerPlayerSetting2.png" width="min(500px,100%)" />
          <q-stepper-navigation>
      ...
      <q-stepper v-model="step_run" flat vertical animated>
        <q-step :name="1" title="1. 設定" :done="step_run > 1">
          ...
          <q-img src="src/assets/Introduction/MainWindow.png" width="min(900px,100%)" />
          <q-stepper-navigation>
        ...
        <q-step :name="2" title="2. 起動" :done="step_run > 2">
          ...
          <q-img src="src/assets/Introduction/Server1.png" width="min(700px,100%)" />
          ...
          <q-img src="src/assets/Introduction/Server2.png" width="min(700px,100%)" />
          <q-stepper-navigation>
      ...
      <q-stepper v-model="step_participant" flat vertical animated>
        <q-step :name="1" title="1. Minecraftの起動" :done="step_participant > 1">
          ...
          <q-img src="src/assets/Introduction/Launcher.png" width="min(500px,100%)" />
          <q-stepper-navigation>
        ...
        <q-step :name="2" title="2. マルチプレイの設定" :done="step_participant > 2">
          ...
          <q-img src="src/assets/Introduction/client.png" width="min(500px,100%)" />
          <q-stepper-navigation>
        ...
        <q-step :name="3" title="3. ほかの人がサーバーに参加する" :done="step_participant > 3">
          ...
          <div class="row q-gutter-md">
            <q-img src="src/assets/Introduction/ip.png" width="min(500px,100%)" />
            <q-img src="src/assets/Introduction/client2.png" width="min(500px,100%)" />
          </div>
          <q-stepper-navigation>
